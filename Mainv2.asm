...
; =====================================================================
; CLIC3 Timer System - Complete Fixed Version
; =====================================================================
...
LED_D0          EQU     01h
LED_D7          EQU     80h
S3_DEBOUNCE_MS  EQU     20
BLINK_MS        EQU     250
KEY_POLL_MS     EQU     20
KEY_DEBOUNCE_TICKS EQU  2
...
S3_Same:
            CMP.W       #S3_DEBOUNCE_MS, s3_debounce_cnt
            JGE         S3_CheckStable
...
KP_Check_Process:
            ...
            MOV.B       #1, key_processed
            MOV.B       R12, g_key_stable
